...
-- Stores extended profile data for faculty users (1-to-1 with users)
-- -------------------------------------------------------
...
-- -------------------------------------------------------
-- Alter: dept_faculty — link department faculty entries to user accounts
-- -------------------------------------------------------
...
-- -------------------------------------------------------
-- Seed: Grant Faculty group access to Faculty Profile module
-- -------------------------------------------------------
