...
SET @preparedStatement = (SELECT IF(
  ...
  CONCAT("ALTER TABLE ", @tablename, " ADD COLUMN ", @columnname, " INT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'One-time admission day cost; already paid separately – stored for reference'")
));
