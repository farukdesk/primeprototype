<?php
/**
 * Reviewer Queue – lists submitted mark sheets awaiting review.
 */
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <span class="badge bg-primary bg-opacity-10 text-primary" style="font-size:.85rem;">
...
<div class="card" style="border-radius:12px;">
    <div class="card-header py-3 px-4">
        <h6 class="mb-0 fw-semibold"><i class="fas fa-search me-2 text-muted"></i>Mark Sheets Awaiting Review</h6>
    </div>
            ...
            <table class="table table-hover mb-0">
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <small><?= $s['submitted_at'] ? date('d M Y', strtotime($s['submitted_at'])) : '—' ?></small>
                        </td>
