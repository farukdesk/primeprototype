...
CREATE TABLE IF NOT EXISTS `admissions_applications` (
    ...
    `office_university_batch` VARCHAR(100) NULL,
    `office_dept_batch`       VARCHAR(100) NULL,
    `office_section`          VARCHAR(100) NULL,
    `office_shift`            VARCHAR(100) NULL,
...
('office_university_batch',  'Office: University Batch',        45),
('office_dept_batch',        'Office: Department Batch',        46),
('office_section',           'Office: Section',                 47),
('office_shift',             'Office: Shift',                   48),
('office_decision',         'Office: Decision',                49),
('office_checked_by',       'Office: Checked By',              50);
