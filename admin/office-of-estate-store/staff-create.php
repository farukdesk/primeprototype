...
require_access('office-of-estate-store', 'can_create');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        db()->prepare(
            'INSERT INTO es_staff (name, title, email_1, email_2, phone, photo, sort_order, is_active)
             VALUES (?,?,?,?,?,?,?,?)'
        )->execute([$name, $title, $email_1, $email_2, $phone, $photo, $sort_order, $is_active]);
