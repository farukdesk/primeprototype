...
require_access('office-of-pro-vc');

$page_title = 'Office of the Pro Vice Chancellor';
...
$pvc_name     = $s['pvc_name'] ?? 'Not configured';
$pvc_title    = $s['pvc_title'] ?? '';
$ps_name      = $s['ps_name'] ?? '';
$ps_title     = $s['ps_title'] ?? '';
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Office of the Pro Vice Chancellor</li>
        </ol>
    </nav>
    <a href="<?= $frontend_base ?>/office-of-pro-vc.php" target="_blank"
...
<div class="alert <?= $is_published ? 'alert-success' : 'alert-warning' ?> d-flex align-items-center gap-2 mb-4"
    ...
    <span>
        ...
        <?php if (!$is_published): ?>
        <a href="<?= APP_URL ?>/office-of-pro-vc/settings.php" class="alert-link">Enable publishing in settings.</a>
        <?php endif; ?>
    </span>
</div>
                ...
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div class="flex-grow-1">
                        <h6 class="mb-1 fw-semibold" style="color:#002147;">
                            <i class="fas fa-user-graduate me-2 text-muted" style="font-size:.85rem;"></i>Pro Vice Chancellor
                        </h6>
                        <div class="fw-medium"><?= h($pvc_name) ?></div>
                        <div style="font-size:.8rem;color:#64748b;"><?= h($pvc_title) ?></div>
                    </div>
                </div>
                <hr style="border-color:#f1f5f9;margin:16px 0 12px;">
                <?php if (can_access('office-of-pro-vc', 'can_edit')): ?>
                <a href="<?= APP_URL ?>/office-of-pro-vc/settings.php?tab=provc"
                   class="btn btn-sm btn-primary" style="border-radius:8px;font-size:.8rem;">
                    <i class="fas fa-edit me-1"></i> Edit Pro VC Profile
                </a>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div class="flex-grow-1">
                        <h6 class="mb-1 fw-semibold" style="color:#1a4faf;">
                            <i class="fas fa-id-badge me-2 text-muted" style="font-size:.85rem;"></i>PS to Pro VC
                        </h6>
                        <div class="fw-medium"><?= $ps_name !== '' ? h($ps_name) : '<span style="color:#94a3b8;font-style:italic;font-size:.85rem;">Not configured</span>' ?></div>
                        <div style="font-size:.8rem;color:#64748b;"><?= h($ps_title) ?></div>
                    </div>
                </div>
                <hr style="border-color:#f1f5f9;margin:16px 0 12px;">
                <?php if (can_access('office-of-pro-vc', 'can_edit')): ?>
                <a href="<?= APP_URL ?>/office-of-pro-vc/settings.php?tab=ps"
        ...
        <div class="card h-100" style="border-top:4px solid #D21034;border-radius:12px;">
            <div class="card-body p-4">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div class="flex-grow-1">
                        <h6 class="mb-1 fw-semibold" style="color:#D21034;">Pro VC Message</h6>
                        <div style="font-size:.82rem;color:#64748b;">
                            <?= h($s['message_title'] ?? 'Message from the Pro Vice Chancellor') ?>
                        </div>
                ...
                <hr style="border-color:#f1f5f9;margin:16px 0 12px;">
                <?php if (can_access('office-of-pro-vc', 'can_edit')): ?>
                <a href="<?= APP_URL ?>/office-of-pro-vc/settings.php?tab=message"
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div style="font-size:.82rem;color:#64748b;">
                            <?= h($s['hero_title'] ?? 'Office of the Pro Vice Chancellor') ?>
                        </div>
                        <div class="mt-2">
                ...
                <hr style="border-color:#f1f5f9;margin:16px 0 12px;">
                <?php if (can_access('office-of-pro-vc', 'can_edit')): ?>
                <a href="<?= APP_URL ?>/office-of-pro-vc/settings.php?tab=page"
