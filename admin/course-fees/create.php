...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $db->prepare(
            'INSERT INTO cf_programs (dept_id, program_id, degree_type, credit_fee, total_credits, duration_years, is_active, sort_order, created_by)
             VALUES (?,?,?,?,?,?,?,?,?)'
        )->execute([$dept_id, $program_id, $degree_type, $credit_fee, $total_credits, $duration, $is_active, $sort_order, $user['id']]);
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="total_credits" class="form-control" min="0" max="999"
                                   value="<?= h(old('total_credits')) ?>" placeholder="e.g. 136">
                            <div class="form-text">Optional, shown on public page.</div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <table class="table mb-0" id="fees-table">
                            ...
                            <tbody id="fees-body">
                                ...
                                <tr class="fee-row">
                                    ...
                                    <td><select name="fee_type[]" class="form-select form-select-sm"><option value="one_time">One-Time</option><option value="per_semester" selected>Per Semester</option></select></td>
