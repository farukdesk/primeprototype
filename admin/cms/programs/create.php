...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        db()->prepare(
            'INSERT INTO cms_programs (title, description, link_url, link_text, sort_order, is_active)
             VALUES (?,?,?,?,?,?)'
        )->execute([$title, $description ?: null, $link_url ?: null, $link_text ?: 'Read More', $sort_order, $is_active]);

        flash_set('success', 'Program added successfully.');
        redirect(APP_URL . '/cms/programs/index.php');
    }

    save_old(compact('title', 'description', 'link_url', 'link_text', 'sort_order'));
}
...
<div class="card">
    <div class="card-header py-3 px-4">
        <h6 class="mb-0 fw-semibold"><i class="fas fa-graduation-cap me-2 text-muted"></i>New Program</h6>
    </div>
        ...
        <form method="POST" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" class="form-control" value="<?= old('title') ?>"
                       placeholder="e.g. Bachelor Degree" maxlength="255" required>
            </div>

            <div class="mb-3">
                <label class="form-label fw-medium">Description</label>
                <textarea name="description" class="form-control" rows="4"
                          placeholder="Short description shown on the homepage card."><?= old('description') ?></textarea>
            </div>
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="link_text" class="form-control" value="<?= old('link_text', 'Read More') ?>"
                           placeholder="Read More" maxlength="150">
                </div>
            </div>
