...
// Bank accounts – code 12xx
$bank_accounts_list = db()->query(
    "SELECT * FROM acc_accounts WHERE type = 'asset' AND code LIKE '12%' AND is_active = 1 ORDER BY code ASC"
)->fetchAll();

$account_id = (int)($_GET['account_id'] ?? ($bank_accounts_list[0]['id'] ?? 0));
...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    <div>
        <h4 class="mb-0 fw-semibold"><i class="fas fa-university me-2 text-primary"></i>Bank Book</h4>
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body p-3">
        <form method="get" class="row g-2 align-items-end">
            <div class="col-md-4">
                <label class="form-label small fw-semibold mb-1">Bank Account</label>
                <select name="account_id" class="form-select form-select-sm">
                    <?php if (empty($bank_accounts_list)): ?>
                    <option value="">No bank accounts found</option>
                    <?php else: ?>
                    <?php foreach ($bank_accounts_list as $a): ?>
...
<div class="card border-0 shadow-sm">
    <div class="card-header py-2 px-4">
        <strong>Bank Book — <?= h($account['name']) ?></strong>
        ...
        <div class="table-responsive">
            <table class="table align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr><td colspan="6" class="text-center text-muted py-4">No bank transactions in this period.</td></tr>
                    <?php endif; ?>
                </tbody>
...
<div class="card border-0 shadow-sm">
    <div class="card-body text-center py-5 text-muted">
        ...
        <p>No bank accounts found. Please add a bank account (code starting with 12) in the Chart of Accounts.</p>
    </div>
</div>
<?php endif; ?>
