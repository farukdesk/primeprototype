...
/**
 * LAST DATE OF PAYMENT for a monthly fee installment (display only).
 * Dues are COUNTED as due from the 1st of the month; the 10th is only the
 * payment deadline – it never delays when a due starts counting.
 */
const ACC_MONTHLY_LAST_PAYMENT_DAY = 10;
