...
require_access('dept-notices', 'can_create');
...
$page_title = 'Add Notice – ' . $dept['name'];
$errors = [];
clear_old();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        db()->prepare(
            'INSERT INTO dept_notices (dept_id, title, content, attachment, notice_date, is_active)
             VALUES (?,?,?,?,?,?)'
    ...
    save_old(compact('title','content','notice_date'));
}
...
<div class="card">
    <div class="card-header py-3 px-4">
        <h6 class="mb-0 fw-semibold"><i class="fas fa-bell me-2 text-muted"></i>Add Notice</h6>
    </div>
        ...
        <form method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="content" class="form-control" style="border-radius:10px;" rows="5"><?= old('content') ?></textarea>
                </div>
                <div class="col-md-6">
