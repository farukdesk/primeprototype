...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        db()->prepare(
            'INSERT INTO dept_academic_programs
             (dept_id, program_name, degree_type, duration, total_credit, semester_type, description, details_content, fees_content, attachment, sort_order, is_active)
             VALUES (?,?,?,?,?,?,?,?,?,?,?,?)'
    ...
    save_old(compact('program_name','degree_type','duration','total_credit','semester_type','description','details_content','fees_content','sort_order'));
}
