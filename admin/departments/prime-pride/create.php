...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        db()->prepare(
            'INSERT INTO dept_prime_pride
             (dept_id, title, description, image, student_name, position, batch_year, sort_order, is_active)
             VALUES (?,?,?,?,?,?,?,?,?)'
    ...
    save_old(compact('title','description','student_name','position','batch_year','sort_order'));
}
