<?php
/**
 * AJAX – filtered + paginated student search within a batch for bulk enrollment.
 * Accepts: batch_id (required), q (search string), section, shift,
...
if ($batch_id <= 0) {
    echo json_encode(['rows' => [], 'total' => 0, 'page' => 1, 'per_page' => $per_page, 'pages' => 0]);
    exit;
}
