...
$page_title = 'Office of Vice Chancellor';
...
$vc_name      = $s['vc_name'] ?? 'Not configured';
$vc_title     = $s['vc_title'] ?? '';
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Office of Vice Chancellor</li>
        </ol>
    </nav>
    <a href="<?= $frontend_base ?>/office-of-vc.php" target="_blank"
...
<div class="alert <?= $is_published ? 'alert-success' : 'alert-warning' ?> d-flex align-items-center gap-2 mb-4"
    ...
    <span>
        ...
        <?php if (!$is_published): ?>
        <a href="<?= APP_URL ?>/office-of-vc/settings.php" class="alert-link">Enable publishing in settings.</a>
        <?php endif; ?>
    </span>
</div>
        ...
        <div class="card h-100" style="border-top:4px solid #002147;border-radius:12px;">
            <div class="card-body p-4">
                <div class="d-flex align-items-start gap-3">
                    <?php if ($vc_photo): ?>
                    <img src="<?= UPLOAD_URL ?>/office-of-vc/<?= h($vc_photo) ?>"
                    ...
                    <div class="flex-grow-1">
                        <h6 class="mb-1 fw-semibold" style="color:#002147;">
                            <i class="fas fa-user-tie me-2 text-muted" style="font-size:.85rem;"></i>Vice Chancellor
                        </h6>
                        <div class="fw-medium"><?= h($vc_name) ?></div>
                        <div style="font-size:.8rem;color:#64748b;"><?= h($vc_title) ?></div>
                    </div>
                </div>
                <hr style="border-color:#f1f5f9;margin:16px 0 12px;">
                <?php if (can_access('office-of-vc', 'can_edit')): ?>
                <a href="<?= APP_URL ?>/office-of-vc/settings.php?tab=vc"
                   class="btn btn-sm btn-primary" style="border-radius:8px;font-size:.8rem;">
                    <i class="fas fa-edit me-1"></i> Edit VC Profile
                </a>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="col-xl-6 col-lg-6">
        <div class="card h-100" style="border-top:4px solid #1a4faf;border-radius:12px;">
            <div class="card-body p-4">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div class="flex-grow-1">
                        <h6 class="mb-1 fw-semibold" style="color:#1a4faf;">
                            <i class="fas fa-id-badge me-2 text-muted" style="font-size:.85rem;"></i>Personal Secretary
                        </h6>
                ...
                <hr style="border-color:#f1f5f9;margin:16px 0 12px;">
                <?php if (can_access('office-of-vc', 'can_edit')): ?>
                <a href="<?= APP_URL ?>/office-of-vc/settings.php?tab=ps"
        ...
        <div class="card h-100" style="border-top:4px solid #D21034;border-radius:12px;">
            <div class="card-body p-4">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div class="flex-grow-1">
                        <h6 class="mb-1 fw-semibold" style="color:#D21034;">VC Message</h6>
                        <div style="font-size:.82rem;color:#64748b;">
                            <?= h($s['message_title'] ?? 'Message from the Vice Chancellor') ?>
                        </div>
                ...
                <hr style="border-color:#f1f5f9;margin:16px 0 12px;">
                <?php if (can_access('office-of-vc', 'can_edit')): ?>
                <a href="<?= APP_URL ?>/office-of-vc/settings.php?tab=message"
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div style="font-size:.82rem;color:#64748b;">
                            <?= h($s['hero_title'] ?? 'Office of the Vice Chancellor') ?>
                        </div>
                        <div class="mt-2">
                ...
                <hr style="border-color:#f1f5f9;margin:16px 0 12px;">
                <?php if (can_access('office-of-vc', 'can_edit')): ?>
                <a href="<?= APP_URL ?>/office-of-vc/settings.php?tab=page"
