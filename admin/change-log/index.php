...
// The Change Log records staff actions only.  Rows written by third-party API
// clients (admin/api/v1, e.g. the partner portal in ss-portal-api/) are never
// shown here; that traffic is audited separately in api_client_requests.
...
// LEFT JOIN: old entries may point to a deleted user and must stay visible.
