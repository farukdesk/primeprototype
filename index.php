         ...
         <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
               <div class="it-footer-widget it-footer-col-1-1">
                  <div class="it-footer-widget-logo mb-30"><a href="index.php"><img src="assets/img/logo/logo-black.png" alt="Prime University"></a></div>
                  <div class="it-footer-widget-text"><p>Empowering future leaders through quality education, research and vibrant campus life since 1993.</p></div>
                  <div class="it-footer-widget-btn">
                     <a href="contact.php" class="it-btn-yellow theme-bg border-radius-100">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
               <div class="it-footer-widget">
                  ...
                  <div class="it-footer-widget-menu"><ul>
                     ...
                     <li><a href="jobs.php">Career Opportunities</a></li>
                     <li><a href="scholarships-waivers.php">Scholarships</a></li>
                  </ul></div>
               </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
               <div class="it-footer-widget">
                  <h4 class="it-footer-widget-title">Student Services</h4>
                  <div class="it-footer-widget-menu"><ul>
               ...
               <div class="it-footer-widget d-flex justify-content-lg-end">
                  <div>
                     ...
                     <div class="it-footer-widget-contact mb-25"><ul>
                        <li><span>Phone:</span><a href="tel:+8801710996196">+880-1710-996196</a></li>
                        <li><span>Email:</span><a href="mailto:info@primeuniversity.edu.bd">info@primeuniversity.edu.bd</a></li>
                        <li><span>Location:</span><a target="_blank" rel="noopener" href="https://maps.google.com/?q=Prime+University+Dhaka">114/116, Mazar Rd, Dhaka-1216</a></li>
                     </ul></div>
                  </div>
               </div>
            </div>
         ...
         <div class="row align-items-center">
            <div class="col-12">
               <div class="it-copyright-left style-2 text-center">
                  <p class="mb-0">Copyright &copy; <?php echo date('Y'); ?> <a href="index.php">Prime University</a>. All Rights Reserved.</p>
               </div>
            </div>
         </div>
      </div>
