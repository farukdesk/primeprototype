                  ...
                  <div class="it-footer-widget it-footer-col-1-2">
                     ...
                     <div class="it-footer-widget-menu">
                        <ul>
                           ...
                           <li><a href="scholarships-waivers.php">Scholarships &amp; Waivers</a></li>
                     ...
                     <div>
                        ...
                        <div class="it-footer-widget-contact mb-25">
                           <ul>
                              ...
                              <li><span>Address:</span><a target="_blank" href="https://www.google.com/maps/dir///@24.4503253,17.1644279,4.17z">114, 116 Mazar Rd, Dhaka 1216</a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row align-items-center">
               <div class="col-12">
                  <div class="it-copyright-left style-2 text-center">
                     <p class="mb-0">Copyright &copy; <?= date('Y') ?> <a href="<?= fh(SITE_URL) ?>/index.php">Prime University</a> All Rights Reserved</p>
                  </div>
               </div>
            </div>
         </div>
