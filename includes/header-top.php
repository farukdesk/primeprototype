<?php
/**
 * Front-end include: Header Top Bar
 * Pulls contact info, quick links, and social media URLs from cms_header_settings.
 */
...
$find_result_text       = $hs['find_result_text']       ?? 'Certificate Verification';
               ...
               <ul>
                  <li class="d-none d-lg-inline-block">
                     <div class="it-header-top-contact d-flex align-items-center">
                        ...
                        <a class="border-line" href="tel:<?= fh(sanitize_phone($phone)) ?>"><?= fh($phone) ?></a>
                     </div>
                  </li>
                  <li>
                     <div class="it-header-top-contact d-flex align-items-center">
         ...
         <div class="col-xl-8 col-lg-7 col-md-8 col-sm-7 d-none d-sm-block">
            <div class="it-header-top-right-action d-flex align-items-center justify-content-end">
               ...
               <div class="it-header-top-social-box align-items-center d-none d-md-flex">
                  ...
                  <a href="<?= fh($twitter_url) ?>" target="_blank" rel="noopener">
                  <?php else: ?>
                  <a href="#">
                  <?php endif; ?>
                  ...
                  <a href="<?= fh($instagram_url) ?>" target="_blank" rel="noopener">
                  <?php else: ?>
                  <a href="#">
                  <?php endif; ?>
                  ...
                  <a href="<?= fh($linkedin_url) ?>" target="_blank" rel="noopener">
                  <?php else: ?>
                  <a href="#">
                  <?php endif; ?>
