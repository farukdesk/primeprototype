            ...
            <div class="row">
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50">
                  <div class="it-footer-widget it-footer-col-1-3">
                     <h4 class="it-footer-widget-title">Admissions</h4>
                     <div class="it-footer-widget-menu">
                        <ul>
                           <li><a href="admission-summer-2026.html">Apply Now</a></li>
                           <li><a href="credit-transfer.php" aria-current="page">Credit Transfer</a></li>
                     ...
                     <div>
                        ...
                        <div class="it-footer-widget-contact mb-25">
                           <ul>
                              ...
                              <li><span>Location:</span><a target="_blank" href="https://www.google.com/maps/@23.7934913,90.3547073,15z">114, 116 Mazar Rd, Dhaka 1216</a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
